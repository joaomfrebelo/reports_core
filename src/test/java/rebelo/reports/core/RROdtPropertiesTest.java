 ...
 * @author João Rebelo
 */
public class RROdtPropertiesTest {
    
    public static RROdtProperties properties;
    
    public RROdtPropertiesTest() {
    }
    ...
    /**
     * Test of getSimpleOdtExporterConfiguration method, of class RROdtProperties.
     * @throws rebelo.reports.core.NullNotAllowedException
     */
    @Test
    public void testGetSimpleOdtExporterConfiguration() throws NullNotAllowedException {
        assertTrue(properties.getSimpleOdtExporterConfiguration() instanceof SimpleOdtExporterConfiguration);
    }
