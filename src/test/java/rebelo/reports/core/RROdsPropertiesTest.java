 ...
 * @author João Rebelo
 */
public class RROdsPropertiesTest {
    
    public static RROdsProperties properties;
    
    public RROdsPropertiesTest() {
    }
    
    @BeforeClass
    public static void setUpClass() throws NullNotAllowedException, RRPropertiesException {
        Configurator.setLevel(rebelo.reports.core.RROdsProperties.class.getName(), Level.ALL);
        ...
        properties = new RROdsProperties(rrProp);
    }
    ...
    /**
     * Test of getSimpleOdsExporterConfiguration method, of class RROdsProperties.
     * @throws rebelo.reports.core.NullNotAllowedException
     */
    @Test
    public void testGetSimpleOdsExporterConfiguration() throws NullNotAllowedException {
        assertTrue(properties.getSimpleOdsExporterConfiguration() instanceof SimpleOdsExporterConfiguration);
    }
