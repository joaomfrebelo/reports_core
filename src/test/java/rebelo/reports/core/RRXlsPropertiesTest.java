 ...
 * @author João Rebelo
 */
public class RRXlsPropertiesTest {
    
    public static RRXlsProperties properties;
    
    public RRXlsPropertiesTest() {
    }
    
    @BeforeClass
    public static void setUpClass() throws NullNotAllowedException, RRPropertiesException {
        Configurator.setLevel(rebelo.reports.core.RRXlsProperties.class.getName(), Level.ALL);
        ...
        properties = new RRXlsProperties(rrProp);
    }
    ...
    /**
     * Test of getSimpleXlsReportConfiguration method, of class RRXlsProperties.
     * @throws rebelo.reports.core.NullNotAllowedException
     */
    @Test
    public void testGetSimpleXlsReportConfiguration() throws NullNotAllowedException {
        assertTrue(properties.getSimpleXlsReportConfiguration() instanceof  SimpleXlsReportConfiguration);
    }

    /**
     * Test of getSimpleOutputStreamExporterOutput method, of class RRXlsProperties.
     * @throws rebelo.reports.core.NullNotAllowedException
     */
    @Test
