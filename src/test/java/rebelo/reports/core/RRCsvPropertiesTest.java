 ...
 * @author João Rebelo
 */
public class RRCsvPropertiesTest {
    
    public static RRCsvProperties properties;
    
    public RRCsvPropertiesTest() {
    }
    
    @BeforeClass
    public static void setUpClass() throws NullNotAllowedException {
        Configurator.setLevel(rebelo.reports.core.RRCsvProperties.class.getName(), Level.ALL);
        RRProperties rrProp = new RRProperties();
        rrProp.setOutputFile("teste");
        properties = new RRCsvProperties(rrProp);
    }
    ...
    /**
     * Test of getSimpleCsvReportConfiguration method, of class RRCsvProperties.
     * @throws rebelo.reports.core.NullNotAllowedException
     */
    @Test
    public void testGetSimpleCsvReportConfiguration() throws NullNotAllowedException {
        assertTrue(properties.getSimpleCsvReportConfiguration() instanceof SimpleCsvReportConfiguration);
    }
