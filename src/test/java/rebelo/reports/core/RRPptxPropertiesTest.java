 ...
 * @author João Rebelo
 */
public class RRPptxPropertiesTest {
    
    public static RRPptxProperties properties;
    
    public RRPptxPropertiesTest() {
    }
    
    @BeforeClass
    public static void setUpClass() throws NullNotAllowedException {
        Configurator.setLevel(rebelo.reports.core.RRPptxProperties.class.getName(), Level.ALL);
        RRProperties rrProp = new RRProperties();
        rrProp.setOutputFile("teste");
        properties = new RRPptxProperties(rrProp);
    }
    ...
    /**
     * Test of getSimplePptxExporterConfiguration method, of class RRPptxProperties.
     * @throws rebelo.reports.core.NullNotAllowedException
     */
    @Test
    public void testGetSimplePptxExporterConfiguration() throws NullNotAllowedException {
        assertTrue(properties.getSimplePptxExporterConfiguration() instanceof SimplePptxExporterConfiguration);
    }
